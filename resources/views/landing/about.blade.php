...
<body>
    ...
    <div class="container content-section">
        ...
        <!-- About Content -->
        <div class="mb-5">
            <p>Laboratorium Komputer Program Studi Informatica, Universitas Udayana, adalah fasilitas akademik yang didedikasikan untuk mendukung kegiatan belajar-mengajar, penelitian, dan pengembangan teknologi informasi. Sebagai pusat kegiatan akademik, laboratorium ini menyediakan infrastruktur terkini dan lingkungan yang kondusif bagi mahasiswa dan dosen untuk mengeksplorasi berbagai aspek ilmu komputer.</p>
            
            <p>Laboratorium ini juga menjadi wadah kolaborasi antara mahasiswa, dosen, dan praktisi untuk menciptakan inovasi teknologi yang bermanfaat bagi masyarakat. Dengan visi menjadi pusat keunggulan di bidang teknologi informasi, kami terus berkomitmen untuk memberikan pelayanan terbaik dalam menunjang pembelajaran dan riset.</p>
        </div>
        ...
        <div class="profile-card">
            <h3>Nama Lengkap</h3>
            <p>I Gusti Agung Gede Arya Kadyanan, S.Kom., M.Kom.</p>
        ...
        <table class="research-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>"Perancangan Sistem Rekomendasi Untuk Menentukan Dewasa Ayu (Hari Baik) Untuk Pelaksanaan Yadnya Di Bali"</td>
                    <td>2017</td>
                </tr>
                <tr>
                    <td>"Pengembangan Web Portal Wisata Terintegrasi E-Commerce Untuk Pelayanan Pertunjukan Seni Dan Budaya"</td>
                    <td>2018</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>"Aplikasi Sistem Informasi Pengelolaan Pertunjukan Seni Terintegrasi Berbasis Crowd Sourcing"</td>
                    <td>2019</td>
                </tr>
            </tbody>
        </table>
