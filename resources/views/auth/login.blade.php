...
@section('main')
    <div class="w-[max(40%,600px)] h-screen p-8 text-center bg-white flex flex-col justify-center">
        ...
        <form id="form" method="POST" class="w-full" action="{{ route('login.submit') }}">
            @csrfSS
            ...
            <div class="mt-4">
                <button type="submit" class="p-2 text-white border-0 rounded-lg  bg-sky-500 hover:bg-sky-600 ">Login</button>
            </div>
