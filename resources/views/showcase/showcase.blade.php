                    ...
                    <div class="card" style="height: 400px; overflow: hidden;">
                        <div class="card-body" style="padding: 1rem;">
                            ...
                            <div class="card">
                                <div class="card-body text-center" style="padding: 5px;">
                                    ...
                                    <img src="{{ asset("storage/showcase/images/{$project->image}") }}"
                                        alt="Project Image" class="img-fluid mb-1"
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <a href="#" class="btn btn-primary btn-sm" data-toggle="modal"
                                data-target="#projectModal" data-title="{{ $project->title }}"
                                data-description="{{ $project->description }}" data-credit="{{ $project->credit }}"
                                ...
                                data-author="{{ $project->user->name ?? 'Unknown' }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mt-3">
                                ...
                                <a id="projectDemoLink" href="#" target="_blank"
